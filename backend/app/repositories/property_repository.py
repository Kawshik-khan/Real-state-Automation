...
CANONICAL_PROPERTIES: List[Dict[str, Any]] = [
    ...
    {
        "id": "proj_sky_tower_banani",
        "name": "GLG Sky Tower",
        "location": {
            "area": "Banani",
            "city": "Dhaka",
            "country": "Bangladesh",
            "formatted": "Road 11, Block D, Banani, Dhaka, Bangladesh",
        },
        "pricing": {
            "currency": "BDT",
            "amount": 18500000,
            "display_bn": "৳১.৮৫ কোটি",
            "display_en": "1.85 Crore BDT (৳18,500,000)",
            "effective_from": "2026-09-01",
        },
        "facts": {
            "bedrooms": 3,
            ...
            "size_sqft": 2450,
            "handover_date": "December 2026",
            "amenities": ["Rooftop Infinity Pool", "Private Helipad Access", "Dedicated EV Charging", "Smart Home Automation", "24/7 Concierge", "Three-Tier Security"],
        },
        "description": "Flagship 3 BHK luxury penthouse and executive units in prestigious Banani Road 11 with panoramic city views and state-of-the-art building automation.",
    ...
    def to_legacy_dict_format(self) -> List[Dict[str, Any]]:
        ...
        for p in self._properties:
            legacy.append({
                ...
                "size_sqft": p["facts"].get("size_sqft"),
                "handover_date": p["facts"].get("handover_date"),
                "handover": p["facts"].get("handover_date"),
